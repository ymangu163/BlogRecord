...
import com.common.utils.DpUtil;
import com.enclose.R;
import com.enclose.adapter.PopupAdapter;
import com.enclose.popup.CommonPopupWindow;
...
//        popupWindow.showAtLocation(findViewById(android.R.id.content), Gravity.NO_GRAVITY, positions[0], positions[1] - popupWindow.getHeight());
    ...
    public void getChildView(View view, int layoutResId) {
        //获得PopupWindow布局里的View
            if(layoutResId == R.layout.popup_down) {
            ...
            } else if (layoutResId == R.layout.popup_up) {
            ...
            } else if (layoutResId == R.layout.popup_left_or_right) {
