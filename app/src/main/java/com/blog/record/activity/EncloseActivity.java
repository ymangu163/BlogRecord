...
import com.enclose.activity.PopupWindowActivity;
...
public class EncloseActivity extends AppCompatActivity {
    ...
    private void initData() {
        String[] array = getResources().getStringArray(R.array.enclose_array);
